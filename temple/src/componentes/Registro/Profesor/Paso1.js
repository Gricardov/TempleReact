...
const exacto = (val, tam) => (val) && (val.length == tam);
                ...
                >
                    {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
                        <Form>
                            ...
                            <FormGroup row>
                                <Label htmlFor="txtDni" xs={12}>DNI: </Label>
                                <Col xs={12}>
                                    <Input
                                        type="text"
                                        tag={Field}
                                    ...
                                    />
                                    {errors.dni && touched.dni ? <MensajeError mensaje={errors.dni} /> : null}
