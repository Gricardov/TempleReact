                ...
                <div>
                    <ul id="tabs-list" className="row">
                        <li id="li-for-panel-1" className="col-3">
                            <label className="panel-label" id="pstPublicaciones" onClick={() => { this.mostrarPestana(2) }}
                               htmlFor="panel-1-ctrl">Publicaciones</label>
                        </li>
                        <li id="li-for-panel-2" className="col-3">
                            <label className="panel-label" id="pstCursos" onClick={() => { this.mostrarPestana(3) }}
                                htmlFor="panel-2-ctrl">Cursos</label>
                        </li>
                        <li id="li-for-panel-3" className="col-3">
                            <label className="panel-label" id="pstHorarios" onClick={() => { this.mostrarPestana(4) }}
                                htmlFor="panel-3-ctrl">Horarios</label>
                        </li>
                        <li id="li-for-panel-4" className="col-3">
                            <label className="panel-label" id="pstUbicacion" onClick={() => { this.mostrarPestana(5) }}
