...
import './Inicio.css';
import LateralDerecho from '../../Utilidades/LateralDerecho';
import LateralIzquierdo from '../../Utilidades/LateralIzquierdo';
import Publicaciones from '../../Utilidades/Publicaciones';
import PanelEjercicios from '../../Utilidades/PanelEjercicios';
...
class Inicio extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            navegables: [{ nombre: 'Inicio', numNotif: 0 },
            { nombre: 'Ejercicios', numNotif: 2 },
            { nombre: 'Explorar', numNotif: 100 }],
            gestiones:
                [{ nombre: 'Mis clases', ruta: RUTAS.MIS_CONTRATOS_PROFESOR.ruta },
            ...
            navegableSeleccionado: 0

        }
        this.props.establecerOpcionesBarra(this.state.selectoresResponsivos);
        ...
        return (
            <div className="perfil-debajo-barra panel-fondo">
                <div className="contenedor-inicio-profesor-css-grid">
                    <LateralIzquierdo
                        navegables={this.state.navegables}
                        gestiones={this.state.gestiones}
                        destacados={[
                        ...
                        navegableSeleccionado={this.state.navegableSeleccionado}
                        seleccionarNavegable={(indice) => this.setState({ navegableSeleccionado: indice })} />
                    {
                        this.state.navegableSeleccionado == 0
                            ?
                            <>
