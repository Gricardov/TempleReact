            ...
            return (
                <div className="post profile_post quickFade" key={i}>
                    <div className="post_content">
                                ...
                                <Row>
                                    <Col xs={9}>
                                        <ul className="like_img">
                                            ...
                                            <li><a href="#" className="single_l"><img src="https://s2.r29static.com//bin/entry/2c8/720x864,85/2166446/adele-husband-simon-konecki-2166446.webp" /></a></li>
                        ...
                        <a href="#" className="post_heding">{e.titulo}</a>
                        <p>{e.descripcion}</p>
                    </div>
                    ...
                    <div className="like_comment_area row">
                        ...
                        <div className="col s4 updown_btn">
                            ...
                            <a href="#" className="count_n">{e.compartidos} compartidos</a>
                        </div>
                        <div className="col s4 updown_btn comment_c">
                            <a href="#"><i className="ion-ios-chatboxes-outline"></i></a>
                            <a href="#" className="count_n">{e.comentarios} comentarios</a>
                        </div>
                    </div>
